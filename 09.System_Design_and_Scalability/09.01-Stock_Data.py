'''
09.01 Stock Data: Imagine you are building some sort of service that will be called by up to 1,000 client
    ...
    design the client-facing service that provides the information to client applications?You are
    responsible for the development, rollout, and ongoing monitoring and maintenance of the feed. Describe
